...
public class Main {
    ...
    public static void getGitHubData() {
        try {
            for (int i = 1; i <= 2; i++) {
                HttpURLConnection httpcon = (HttpURLConnection) new URL("https://api.github.com/users/zhamri/followers?per_page=100&page=" + i + "&&access_token=fa85d03e48027c88b38babefea9a91ca06dfda60").openConnection();
    ...
    public static void getNumberOfRepos() {
        try {
            for (int p = 0; p < repoUrl.size(); p++) {
                long total1 = 0;
                int i = 1;
                do {
                    HttpURLConnection httpcon2 = (HttpURLConnection) new URL(repoUrl.get(p).getData0() + "?per_page=100&&page=" + i + "&&access_token=fa85d03e48027c88b38babefea9a91ca06dfda60").openConnection();
    ...
    public static void getNumberOfFollowers() {
        try {
            for (int p = 0; p < followerUrl.size(); p++) {
                long total1 = 0;
                int i = 1;
                do {
                    HttpURLConnection httpcon2 = (HttpURLConnection) new URL(followerUrl.get(p).getData0() + "?per_page=100&&page=" + i + "&&access_token=fa85d03e48027c88b38babefea9a91ca06dfda60").openConnection();
                    httpcon2.addRequestProperty("User-Agent", "Mozilla/5.0");
                    BufferedReader in2 = new BufferedReader(new InputStreamReader(httpcon2.getInputStream()));
                    StringBuilder responseSB2 = new StringBuilder();
                    String line2;
    ...
    public static void getNumberOfFollowing() {
        try {
            for (int p = 0; p < followingUrl.size(); p++) {
                long total1 = 0;
                int i = 1;
                do {
                    HttpURLConnection httpcon2 = (HttpURLConnection) new URL(followingUrl.get(p).getData0() + "?per_page=100&&page=" + i + "&&access_token=fa85d03e48027c88b38babefea9a91ca06dfda60").openConnection();
                    httpcon2.addRequestProperty("User-Agent", "Mozilla/5.0");
                    BufferedReader in2 = new BufferedReader(new InputStreamReader(httpcon2.getInputStream()));
                    StringBuilder responseSB2 = new StringBuilder();
                    String line2;
    ...
    public static void getNumberOfSubscription() {
        try {
            for (int p = 0; p < subscriptionUrl.size(); p++) {
                long total1 = 0;
                int i = 1;
                do {
                    HttpURLConnection httpcon2 = (HttpURLConnection) new URL(subscriptionUrl.get(p).getData0() + "?per_page=100&&page=" + i + "&&access_token=fa85d03e48027c88b38babefea9a91ca06dfda60").openConnection();
                    httpcon2.addRequestProperty("User-Agent", "Mozilla/5.0");
                    BufferedReader in2 = new BufferedReader(new InputStreamReader(httpcon2.getInputStream()));
                    StringBuilder responseSB2 = new StringBuilder();
                    String line2;
    ...
    public static void convertToExcel() {
        ...
        String excelFile = "List_followers.xlsx";
